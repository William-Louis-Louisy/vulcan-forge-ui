...
type TokensEditorPageTranslations = Awaited<ReturnType<typeof getTranslations>>;

type BuildTokensEditorShellLabelsParams = {
  t: TokensEditorPageTranslations;
  tokenSetTypeLabels: Record<TokenSetType, string>;
  totalTokenCount: number;
  missingEnglishDescriptionCount: number;
};

export function buildTokensEditorShellLabels({
  t,
  tokenSetTypeLabels,
  totalTokenCount,
  missingEnglishDescriptionCount,
}: BuildTokensEditorShellLabelsParams): TokensEditorShellLabels {
  return {
    header: {
    ...
    tokenSet: {
      ...
      missingEnglishDescription: t('states.missingEnglishDescription'),
    },
    inspector: {
