  ...
  return (
    <section className="flex min-h-0 flex-col xl:absolute xl:inset-0 xl:h-auto xl:overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col lg:grid lg:grid-cols-[15rem_minmax(0,1fr)] xl:h-full xl:grid-cols-[16rem_minmax(0,48rem)_minmax(24rem,1fr)] xl:overflow-hidden">
        <aside className="border-border-subtle min-h-0 min-w-0 border-b p-3 sm:p-4 lg:row-span-2 lg:border-r lg:border-b-0 xl:row-span-1 xl:h-full xl:overflow-hidden">
        ...
        <aside className="border-border-subtle grid min-h-0 min-w-0 content-start gap-6 border-t p-3 sm:p-4 lg:col-start-2 xl:col-start-auto xl:h-full xl:overflow-hidden xl:border-t-0 xl:border-l">
