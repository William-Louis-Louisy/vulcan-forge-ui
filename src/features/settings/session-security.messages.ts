...
const messages: Record<Locale, SessionSecurityMessages> = {
  en: {
    ...
    description: 'Manage the lifetime and revocation of your authenticated sessions.',
  ...
  fr: {
    ...
    description: 'Gérez la durée et la révocation de vos sessions authentifiées.',
