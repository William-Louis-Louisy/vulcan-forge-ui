...
function createComponentContractEditorLabels(
  ...
  return {
    ...
    visualTokens: {
      ...
      inspectBinding: t('editor.visualTokens.inspectBinding'),
      scope: t('editor.visualTokens.scope'),
      componentScope: t('editor.visualTokens.componentScope'),
      ...
      resolvedValue: t('editor.visualTokens.resolvedValue'),
      tokenStatus: t('editor.visualTokens.tokenStatus'),
      previewEffect: t('editor.visualTokens.previewEffect'),
      previewEffectActive: t('editor.visualTokens.previewEffectActive'),
      previewEffectUnavailable: t(
        'editor.visualTokens.previewEffectUnavailable',
      ),
      diagnostics: {
        title: t('editor.visualTokens.diagnostics.title'),
        unassigned: t('editor.visualTokens.diagnostics.unassigned'),
        missing: t('editor.visualTokens.diagnostics.missing'),
        typeMismatch: t('editor.visualTokens.diagnostics.typeMismatch'),
        unresolved: t('editor.visualTokens.diagnostics.unresolved'),
        deprecated: t('editor.visualTokens.diagnostics.deprecated'),
        resolved: t('editor.visualTokens.diagnostics.resolved'),
        expectedType: t('editor.visualTokens.diagnostics.expectedType'),
        actualType: t('editor.visualTokens.diagnostics.actualType'),
      },
      tokenTypes: {
