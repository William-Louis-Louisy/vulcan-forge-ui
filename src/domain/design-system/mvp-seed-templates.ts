...
export const mvpTokenSetSeeds = [
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        value: '#60A5FA',
        description: {
          en: 'Bright blue for status feedback on dark surfaces.',
          fr: 'Bleu lumineux pour les retours de statut sur surfaces sombres.',
        },
        status: 'ready',
      },
      {
        ...
        value: '#2563EB',
        description: {
          en: 'Strong blue for status feedback on light surfaces.',
          fr: 'Bleu soutenu pour les retours de statut sur surfaces claires.',
        },
        status: 'ready',
      },
      {
        ...
        value: '#4ADE80',
        description: {
          en: 'Bright green for positive status feedback on dark surfaces.',
          fr: 'Vert lumineux pour les retours positifs sur surfaces sombres.',
        },
        status: 'ready',
      },
      {
        ...
        value: '#15803D',
        description: {
          en: 'Strong green for positive status feedback on light surfaces.',
          fr: 'Vert soutenu pour les retours positifs sur surfaces claires.',
        },
        status: 'ready',
      },
      {
        path: 'color.primitive.amber.400',
        type: 'color',
        value: '#FBBF24',
        description: {
          en: 'Bright amber for warning feedback on dark surfaces.',
          fr: 'Ambre lumineux pour les avertissements sur surfaces sombres.',
        },
        status: 'ready',
      },
      {
        path: 'color.primitive.amber.700',
        type: 'color',
        value: '#B45309',
        description: {
          en: 'Strong amber for warning feedback on light surfaces.',
          fr: 'Ambre soutenu pour les avertissements sur surfaces claires.',
        },
        status: 'ready',
      },
      {
        ...
        value: '#F87171',
        description: {
          en: 'Bright red for destructive or error feedback on dark surfaces.',
          fr: 'Rouge lumineux pour les erreurs ou actions destructives sur surfaces sombres.',
        },
        status: 'ready',
      },
      {
        ...
        value: '#B91C1C',
        description: {
          en: 'Strong red for destructive or error feedback on light surfaces.',
          fr: 'Rouge soutenu pour les erreurs ou actions destructives sur surfaces claires.',
        },
        status: 'ready',
      },
      {
      ...
      },
      {
        ...
        description: {
          en: 'Informational status color for light themes.',
          fr: 'Couleur de statut informatif pour les thèmes clairs.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.info.dark',
        type: 'color',
        value: '{color.primitive.blue.400}',
        reference: '{color.primitive.blue.400}',
        description: {
          en: 'Informational status color for dark themes.',
          fr: 'Couleur de statut informatif pour les thèmes sombres.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.success.light',
        type: 'color',
        value: '{color.primitive.green.700}',
        reference: '{color.primitive.green.700}',
        description: {
          en: 'Success status color for light themes.',
          fr: 'Couleur de statut de succès pour les thèmes clairs.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.success.dark',
        type: 'color',
        value: '{color.primitive.green.400}',
        reference: '{color.primitive.green.400}',
        description: {
          en: 'Success status color for dark themes.',
          fr: 'Couleur de statut de succès pour les thèmes sombres.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.warning.light',
        type: 'color',
        value: '{color.primitive.amber.700}',
        reference: '{color.primitive.amber.700}',
        description: {
          en: 'Warning status color for light themes.',
          fr: 'Couleur de statut d’avertissement pour les thèmes clairs.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.warning.dark',
        type: 'color',
        value: '{color.primitive.amber.400}',
        reference: '{color.primitive.amber.400}',
        description: {
          en: 'Warning status color for dark themes.',
          fr: 'Couleur de statut d’avertissement pour les thèmes sombres.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.danger.light',
        type: 'color',
        value: '{color.primitive.red.700}',
        reference: '{color.primitive.red.700}',
        description: {
          en: 'Danger status color for light themes.',
          fr: 'Couleur de statut de danger pour les thèmes clairs.',
        },
        status: 'ready',
      },
      {
        path: 'color.semantic.status.danger.dark',
        type: 'color',
        value: '{color.primitive.red.400}',
        reference: '{color.primitive.red.400}',
        description: {
          en: 'Danger status color for dark themes.',
          fr: 'Couleur de statut de danger pour les thèmes sombres.',
        },
        status: 'ready',
      },
      {
