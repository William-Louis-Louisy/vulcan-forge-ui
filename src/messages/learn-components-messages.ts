    ...
    LearnComponentsPage: {
      ...
      openingProblem: {
        ...
        questions: {
          ...
          behavior: 'What content, accessibility and usage rules must implementations respect?',
        },
        conclusion:
      ...
      definition: {
        ...
        title: 'A component contract describes the stable rules; an instance chooses among them.',
        description:
        ...
        rule:
          'The instance can change from screen to screen. The contract is the common source that keeps those instances coherent.',
      },
      anatomy: {
        eyebrow: 'Anatomy',
      ...
      axes: {
        ...
        rule:
          '“Loading” is not another visual variant of Button in the current seed. It is a state of an instance whose variant and size remain independently defined.',
      },
      rules: {
      ...
      bindings: {
        ...
        title: 'The component can depend on token paths instead of owning raw visual values.',
        description:
      ...
      accessibility: {
        ...
        title: 'Accessibility rules belong in the contract, not in a final QA checklist only.',
        description:
      ...
      structuredSource: {
        ...
        title: 'The contract becomes more valuable when other product surfaces can read it.',
        description:
        ...
        items: {
          ...
          ai:
            'AI instructions tell downstream assistants to use only documented components and variants and not invent APIs, states, slots or accessibility behavior.',
          accessibility:
      ...
      productBridge: {
        ...
        title: 'The current contract model is rich, but the component identity model is still intentionally narrow.',
        description:
        ...
        items: {
          ...
          lifecycle:
            'A contract can be draft, ready or deprecated.',
          localization:
            'Purpose, guidance, labels, descriptions, accessibility rules and forbidden patterns can carry localized content.',
          anatomy:
            'Anatomy parts can be required, optional or derived.',
          axes:
            'Variants, sizes and states are stored as separate structured collections.',
          bindings:
      ...
      demo: {
        ...
        sequence: {
          ...
          component: 'Component · define the reusable contract that consumes system decisions',
        },
      },
      misconception: {
        eyebrow: 'Common misconception',
        title: 'A component contract is neither a screenshot nor a framework component API.',
        description:
      ...
      checkpoint: {
        ...
        items: {
          ...
          three: 'why purpose, content, accessibility and forbidden patterns belong beside visual rules;',
  ...
  fr: {
    LearnComponentsPage: {
      ...
      openingProblem: {
        ...
        title: 'Une capture soignée peut tout de même laisser le composant indéfini.',
        description:
        ...
        questions: {
          ...
          behavior: 'Quelles règles de contenu, d’accessibilité et d’usage les implémentations doivent-elles respecter ?',
        },
        conclusion:
      ...
      definition: {
        ...
        title: 'Un contrat décrit les règles stables ; une instance choisit parmi elles.',
        description:
        ...
        instanceMeta: 'primary · md · loading',
        rule:
          'L’instance peut changer d’un écran à l’autre. Le contrat est la source commune qui maintient leur cohérence.',
      },
      anatomy: {
        eyebrow: 'Anatomie',
      ...
      axes: {
        ...
        title: 'Variante, taille et état répondent à des questions différentes.',
        description:
        ...
        items: {
          ...
          size: {
            label: 'Taille',
            values: 'sm · md · lg',
            meaning: 'Quelle échelle prise en charge du composant est utilisée ?',
          },
          state: {
            label: 'État',
            values: 'focusVisible · disabled · loading',
        ...
        instance: 'Button / primary / md / loading',
        rule:
          '« Loading » n’est pas une nouvelle variante visuelle de Button dans le seed actuel. C’est l’état d’une instance dont la variante et la taille restent définies indépendamment.',
      },
      rules: {
        ...
        items: {
          purpose: {
            title: 'Purpose',
            description: 'Seed actuel : déclenche une action importante de l’utilisateur.',
          },
          usage: {
      ...
      bindings: {
        ...
        title: 'Le composant peut dépendre de chemins de tokens au lieu de posséder des valeurs visuelles brutes.',
        description:
      ...
      accessibility: {
        ...
        title: 'Les règles d’accessibilité appartiennent au contrat, pas seulement à une checklist de QA finale.',
        description:
        ...
        items: {
          accessibleName:
            'Le seed Button actuel exige un nom accessible.',
          keyboard:
      ...
      structuredSource: {
        ...
        title: 'Le contrat gagne en valeur lorsque d’autres surfaces produit peuvent le lire.',
        description:
        ...
        items: {
          ...
          ai:
            'Les instructions IA imposent aux assistants en aval d’utiliser uniquement les composants et variantes documentés et de ne pas inventer d’API, d’états, de slots ou de comportements d’accessibilité.',
          accessibility:
      ...
      productBridge: {
        ...
        title: 'Le modèle de contrat actuel est riche, mais le modèle d’identité des composants reste volontairement étroit.',
        description:
        ...
        items: {
          ...
          lifecycle:
            'Un contrat peut être draft, ready ou deprecated.',
          localization:
          ...
          axes:
            'Variantes, tailles et états sont stockés dans des collections structurées séparées.',
          bindings:
      ...
      demo: {
        ...
        title: 'Quatre chapitres forment maintenant une seule histoire de dépendances.',
        description:
        ...
        sequence: {
          ...
          theme: 'Theme · mapper les rôles d’apparence lorsque le contexte doit varier',
          component: 'Component · définir le contrat réutilisable qui consomme les décisions du système',
        },
      },
      misconception: {
        eyebrow: 'Idée reçue fréquente',
        title: 'Un contrat de composant n’est ni une capture d’écran ni l’API d’un composant de framework.',
        description:
      ...
      checkpoint: {
        ...
        items: {
          ...
          three: 'pourquoi purpose, contenu, accessibilité et patterns interdits doivent accompagner les règles visuelles ;',
